...
?>
        ...
        <table class="table table-bordered" id="tabla_actualizaciones">
            ...
            <tr>
                ...
                <th><?= $this->Paginator->sort('doctor_id', 'Auditor') ?></th>
            ...
            <?php foreach ($reports as $report) : ?>
                <tr>
                    ...
                    <td><?= $report->getDoctorName(); ?></td>
                    <td class="actions">
                        <?php if ($report->isWaitingResults() && $report->isOwner($this->Identity->get('id'))) :
                            echo $this->Html->link('Diagnosticar', $redirectPrefix . '/licencias/diagnosticar/' . $report->id, ['fullBase' => true]);
                        else :

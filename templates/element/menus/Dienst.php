    ...
    <div id="collapsePacientes" class="collapse show" aria-labelledby="pacientes" data-parent="#menuHome">
        <div class="card-body">
            <ul class="sub-menu">
                ...
                <li>
                    <a href="<?= $this->Url->build($redirect . '#', ['fullBase' => true]); ?>" class="btn btn-link" data-togle="pill">Lista de trabajador auditado</a>
                </li>
                <li>
                    <a href="<?= $this->Url->build($redirect . '#', ['fullBase' => true]); ?>" class="btn btn-link" data-togle="pill">Lista de M&eacute;dicos Auditores</a>
                </li>
                <li>
                    <a href="<?= $this->Url->build($redirect . '#', ['fullBase' => true]); ?>" class="btn btn-link" data-togle="pill">Lista de Empresas</a>
                </li>
            </ul>
        </div>
    </div>

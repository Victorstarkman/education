...
class SearchController extends AppController
{
    ...
    public function states()
    {
        ...
        $states = $statesTable->find()->order(['name'=>'ASC'])->combine('id','name')->toArray();
    ...
    public function counties()
    {
        ...
        $counties = $countiesTable->find()->where(['state_id' => $state_id])->order(['name'=>'ASC'])->combine('id', 'name')->toArray();
    ...
    public function cities()
    {
        ...
        $cities = $citiesTable->find()->where(['county_id' => $county_id])->order(['name'=>'ASC'])->combine('id', 'name')->toArray();
